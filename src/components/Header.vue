...
const handleEnter = () => {
    // Проверяем, что поле поиска не пустое и что была нажата клавиша Enter
    ...
    <div class=" flex items-center justify-between  mx-28 my-10    ">
        ...
        <div class="flex flex-col  gap-8 ">
            <nav class="flex gap-5">
                ...
                <RouterLink to="/refund" class=" hover:text-green-600">Условия возврата</RouterLink>
                <RouterLink to="/responsibility" class=" hover:text-green-600">Памятка потребителя</RouterLink>
            </nav>
            <IconField iconPosition="left" class="w-full">
                <InputIcon class="pi pi-search"></InputIcon>
                <InputText @keydown.enter="handleEnter" v-model="filterStore.searchValue" placeholder="Поиск по названию"
                    class="h-10 pl-9  w-full" />
            </IconField>
